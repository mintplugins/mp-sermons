...
function mp_sermon_podcast_settings_general_create(){
	...
	add_settings_field(
		'mp_sermons_general_title',
		__( 'Podcast Title', 'mt_malachi' ), 
		'mp_core_textbox',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_title',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_title' ),
	...
	add_settings_field(
		'mp_sermons_general_subtitle',
		__( 'Podcast Subtitle', 'mt_malachi' ), 
		'mp_core_textbox',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_subtitle',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_subtitle' ),
	...
	add_settings_field(
		'mp_sermons_general_author',
		__( 'Podcast Author', 'mt_malachi' ), 
		'mp_core_textbox',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_author',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_author' ),
	...
	add_settings_field(
		'mp_sermons_general_description',
		__( 'Podcast Description', 'mt_malachi' ), 
		'mp_core_textarea',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_description',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_description' ),
	...
	add_settings_field(
		'mp_sermons_general_image',
		__( 'Podcast Image', 'mt_malachi' ), 
		'mp_core_mediaupload',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_image',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_image' ),
	...
	add_settings_field(
		'mp_sermons_general_cat_1',
		__( 'Category', 'mt_malachi' ), 
		'mp_core_select',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_cat_1',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_cat_1' ),
	...
	add_settings_field(
		'mp_sermons_general_cat_2',
		__( 'Sub-Category', 'mt_malachi' ), 
		'mp_core_select',
		'mp_sermon_podcast_settings_general',
		'general_settings',
		array(
			'name'        => 'mp_sermons_general_cat_2',
			'value'       => mp_core_get_option( 'mp_sermon_podcast_settings_general',  'mp_sermons_general_cat_2' ),
