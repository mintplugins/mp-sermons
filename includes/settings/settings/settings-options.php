 ...
 * Step 2. Do a find-and-replace for the term 'mp_sermon_settings' and replace it with the slug you desire for this page
...
function mp_sermon_settings(){
	 ...
	 *
	 */
	$args = array('parent_slug' => 'edit.php?post_type=mp_sermon', 'title' => __('Sermon Settings', 'mp_core'), 'slug' => 'mp_sermon_settings', 'type' => 'submenu');
	
	//Initialize settings class
	global $mp_sermon_settings;
	$mp_sermon_settings = new MP_CORE_Settings($args);
