...
* Create new tab
*/
$mp_sermon_settings->mp_core_new_tab(__('Media Types' , 'my_plugin'), 'media');
...
function mp_sermon_settings_media_create(){
	...
	add_settings_section(
		'media_settings',
		__( 'Choose your media types', 'mt_malachi' ),
		'__return_false',
		'mp_sermon_settings_media'
	);
	...
	add_settings_field(
		...
		array(
			...
			'preset_value'       => "mp3",
			'description' => __( 'Do you want the ability to upload an MP3 to each sermon?', 'mt_malachi' ),
	...
	add_settings_field(
		...
		array(
			...
			'preset_value'       => "ogv",
			'description' => __( 'Do you want the ability to upload an OGV to each sermon?', 'mt_malachi' ),
			'registration'=> 'mp_sermon_settings_media',
		)
	);
	...
	add_settings_field(
		...
		array(
			...
			'preset_value'       => "mp4",
			'description' => __( 'Do you want the ability to upload an MP4 to each sermon?', 'mt_malachi' ),
			'registration'=> 'mp_sermon_settings_media',
			'checked_by_default' => 'true'
		)
	);
	...
	add_settings_field(
		...
		array(
			...
			'preset_value'       => "webmv",
			'description' => __( 'Do you want the ability to upload an WEBMV to each sermon?', 'mt_malachi' ),
			'registration'=> 'mp_sermon_settings_media',
		)
	);
